    ...
    .factory('$ngConfirmBase', [
        ...
        function ($rootScope, $ngConfirmDefaults, $timeout, $compile, $ngConfirmTemplate, $interval, $templateRequest, $log, $q) {
            ...
            ngConfirmBase.prototype = {
                ...
                _providedScope: false, // has the allUser provided a scope.
                _prepare: function () {
                    var that = this;

                    this.$el = angular.element($ngConfirmTemplate['default']);

                    // Has the allUser provided us with the scope.
                    if (that.scope) {
                 ...
                 *
                 * Setting buttons
                 * The allUser cannot add or remove buttons in run time.
                 * The allUser can however change the buttons properties.
                 *
                 * @param buttons
                 * @private
                 */
