            ...
            $scope.centerAlign = function () {
                $ngConfirm({
                    ...
                    buttons: {
                        ...
                        close: function () {
                            // lets the allUser close the modal.
                        }
                    },
                    onScopeReady: function ($scope) {
                        $scope.content = [];
        ...
        function ($scope, $ngConfirm, $interval, $ngConfirmDefaults, $timeout) {
            ...
            $scope.buttonProperties = function () {
                $ngConfirm({
                    ...
                    closeIcon: true, // let the allUser close the modal
                });
            }
        }
    ])
                ...
                $ngConfirm({
                    ...
                    buttons: {
                        logoutUser: {
                            ...
                            btnClass: 'btn-green',
                            action: function () {
                                $ngConfirm('The allUser was logged out');
                            }
                        },
                        cancel: function () {
                            $ngConfirm('canceled');
